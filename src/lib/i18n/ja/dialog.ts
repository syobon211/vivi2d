export const dialog = {
  "runtimePreview.title": "Runtimeプレビュー",
  "runtimePreview.scope":
    "この複製に対応する.viviのスナップショットを選択して表示します。プロジェクトの編集・保存・公開は行いません。",
  "runtimePreview.open": "プロジェクトをプレビュー",
  "runtimePreview.reload": "再読込",
  "runtimePreview.close": "プレビューを閉じる",
  "runtimePreview.loading": "プレビューを準備中…",
  "runtimePreview.ready": "プレビューを表示しました",
  "runtimePreview.warning":
    "プレビューの状態は反映されましたが、表示または後処理が完了しませんでした。再読込してください。",
  "runtimePreview.missing": "必要な素材が不足しています。現在の表示は維持されます。",
  "runtimePreview.failed": "プレビューに失敗しました。再読込でやり直してください。",
  "runtimePreview.parameter": "パラメータ",
  "runtimePreview.preset": "表情プリセット",
  "runtimePreview.generation": "Runtime世代",
  "localExchange.title": "永続ローカル Job・データ交換",
  "localAssetCopy.title": "参照形式のプロジェクトをローカルコピー",
  "localAssetCopy.scope":
    "受理した正規化済みプロジェクトとPNG素材をローカル複製間でコピーします。Editorへの読込、内容変更、Syncリビジョンの公開は行いません。",
  "localAssetCopy.source": "コピー元の複製",
  "localAssetCopy.receiver": "コピー先の複製",
  "localAssetCopy.prepare": "プロジェクトを選択",
  "localAssetCopy.commit": "素材をコピーして名前を付けて保存",
  "localAssetCopy.cancel": "残りの処理を中止",
  "localAssetCopy.consent":
    "選択したローカル複製へ、この時点のプロジェクトと素材をコピーしますか？ 次に保存先を選択します。途中で失敗・中止しても、コピー済みの不変素材は残ります。",
  "localAssetCopy.unavailable": "現在の実行構成ではコピーを利用できません。",
  "localAssetCopy.failed":
    "コピー結果を確認できませんでした。選択した出力先を確認してから再試行してください。コピー済み素材が残る場合があります。",
  "localAssetCopy.ambiguous":
    "処理が完了した可能性がありますが、結果を確認できません。選択した出力先を確認後、同じプロジェクトを選び直して明示的に再試行してください。",
  "localAssetCopy.committed": "正規化済みコピーを保存したドキュメント:",
  "localExchange.scope":
    "内部ローカルモード。要求と結果はこのコンピューターに保存されます。再起動後に自動実行しません。",
  "localExchange.refresh": "更新",
  "localExchange.createWorkspace": "ローカル作業領域を作成",
  "localExchange.workspace": "作業領域",
  "localExchange.replica": "対応するレプリカを作成",
  "localExchange.publish": "現在の完全な v11 を公開",
  "localExchange.target": "送信先レプリカ",
  "localExchange.queue": "送信先の現在ヘッドを基準に v11 を予約",
  "localExchange.deliver": "配送・同一要求の再送",
  "localExchange.queuePrompt": "プロンプト Job を予約",
  "localExchange.queueImage": "画像を選択して Job を予約",
  "localExchange.job": "Job",
  "localExchange.retry": "明示的に再試行",
  "localExchange.start": "開始",
  "localExchange.cancel": "取消",
  "localExchange.selection": "結果のアーティファクトを明示的に選択",
  "localExchange.consent":
    "保存された候補で現在の編集内容を置き換えますか？未保存の変更は置き換えられます。",
  "localExchange.approve": "通常インポートを承認",
  "localExchange.reject": "提案を却下",
  "localExchange.psd": "別の PSD 変換を予約（サーバー依存）",
  "localExchange.openCandidate": "保存された承認済み候補を開く",
  "localExchange.legacy":
    "通常の Provider インポートは対応データを保持します。v11 Sync リビジョンや Project アーティファクトの直接承認の証明ではありません。",
  "localExchange.failed":
    "操作が失敗したか、状態が変化しました。更新してから改めて明示的に操作してください。",
  "localExchange.unavailable": "ローカルデータ交換を利用できません。",
  "localExchange.integrity": "整合性検証に失敗した保存セルは利用できません。",
