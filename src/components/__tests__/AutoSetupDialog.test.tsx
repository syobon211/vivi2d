...
function render(...args: Parameters<typeof testingLibraryRender>) {
  let result: ReturnType<typeof testingLibraryRender> | undefined;
  act(() => {
    result = testingLibraryRender(...args);
  });
  return result!;
}

const fireEvent = new Proxy(testingLibraryFireEvent, {
  get(target, property, receiver) {
    const event = Reflect.get(target, property, receiver);
...
}) as typeof testingLibraryFireEvent;
